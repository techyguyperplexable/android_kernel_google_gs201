...
void __init tcp_init(void)
{
	...
	/* Acacia: Increased default TCP buffers for mobile networks */
	init_net.ipv4.sysctl_tcp_wmem[0] = PAGE_SIZE;
	init_net.ipv4.sysctl_tcp_wmem[1] = 262144;
	init_net.ipv4.sysctl_tcp_wmem[2] = max(4*1024*1024, max_wshare);

	init_net.ipv4.sysctl_tcp_rmem[0] = PAGE_SIZE;
	init_net.ipv4.sysctl_tcp_rmem[1] = 524288;
	init_net.ipv4.sysctl_tcp_rmem[2] = max(6*1024*1024, max_rshare);
